          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
            ...
            <div>
              ...
              <p className='text-gray-700 mb-8'>
                ...
                flour solution, or want to place an order, our team is ready to
                assist you. Reach out to us using any of the methods below.
              </p>
              ...
              <div className='space-y-6'>
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-700'> Lahore, 54000</p>
                  </div>
                </div>
                ...
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-700'>+92 302 1006666</p>
              ...
              <div className='mt-10 rounded-lg overflow-hidden shadow-md h-64 bg-gray-200'>
                <iframe
                  src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3398.5090976707206!2d74.40358!3d31.5925071!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39191b006f8ddccd%3A0x96e5fecfeb948fdf!2sData%20Flour%20Mills!5e0!3m2!1sen!2s!4v1750922827702!5m2!1sen!2s'
                  width='100%'
                  height='100%'
                  style={{ border: 0 }}
                  allowFullScreen
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-8'>
            <div className='bg-gray-50 p-6 rounded-lg'>
              <h3 className='text-xl font-bold text-primary mb-3'>
                Do you offer custom flour milling services?
              </h3>
              <p className='text-gray-700'>
                Yes, we offer custom milling services for businesses with
                specific flour requirements. Please contact our sales team to
                discuss your needs.
              </p>
            </div>
            ...
            <div className='bg-gray-50 p-6 rounded-lg'>
              ...
              <p className='text-gray-700'>
                Yes, we welcome visitors for facility tours by appointment.
                Please contact us at least one week in advance to schedule a
                visit.
              </p>
            </div>
          </div>
